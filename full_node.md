...
I will not store the blockchain on the RPi sdcard, because this will read and write a lot of times on my sd card it can damage it. I will use USB memory stick to store the blocks.
