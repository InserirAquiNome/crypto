...
This is a link for all the files used on this article. You can check by yourself the integrity and authenticity of the *cat.jpg*  with my public PGP key. And also you can read the *secret.txt* that it's hidden on *cat_set.jpg* with the password **cat**.
