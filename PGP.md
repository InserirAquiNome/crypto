...
I found a amazing [article](https://alexcabal.com/creating-the-perfect-gpg-keypair/) on the web and copy it to my [git repository]()https://github.com/InserirAquiNome/articles/blob/master/misc/PGP2.md.
